...
[!UICONTROL Troubleshooting Agent] assistito da IA può:

* Assistenza nella diagnosi dei problemi di prestazioni e consegna per un pacchetto live o un posizionamento selezionato. Puoi porre domande su includono problemi di spesa (mancata spesa, spesa bassa, spesa eccessiva), problemi di ritmo (underpacing, overpacing), problemi di asta e consegna (offerte basse, basso tasso di vincita, nessuna impression) e problemi di prestazioni (come modifiche in CPA, ROAS, CTR o CVR).
...
### Risoluzione dei problemi di prestazioni e consegna
...
1. (Facoltativo; solo domande generali sul prodotto) Per aprire una pagina utilizzata come origine dati, eseguire una delle operazioni seguenti:

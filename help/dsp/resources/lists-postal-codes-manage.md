---
title: Gestire gli elenchi di codici postali
description: Scopri come creare e gestire gli elenchi di codici postali per il targeting del posizionamento.
...
## Visualizzare un elenco di codici postali

1. Nel menu principale, fare clic su **[!UICONTROL Resources]** > **[!UICONTROL Postal Code Lists]**.
...
## Creare un elenco di codici postali

1. Nel menu principale, fare clic su **[!UICONTROL Resources]** > **[!UICONTROL Postal Code Lists]**.

1. In alto a destra, fare clic su **[!UICONTROL Create].**

1. Immetti **[!UICONTROL List name]**, seleziona il **[!UICONTROL Country]** applicabile, quindi fai clic su **[!UICONTROL Create].**

...
+ Introduzione {#introduction}
   ...
   + Supporto per la privacy del consumatore {#privacy}
      + [Supporto per il regolamento generale sulla protezione dei dati](https://experienceleague.adobe.com/docs/advertising-cloud/privacy/gdpr.html)
      + Supporto per CCPA {#ccpa}
         + [Supporto per il California Consumer Privacy Act: Accesso ed eliminazione dei dati dei consumatori](https://experienceleague.adobe.com/docs/advertising-cloud/privacy/ccpa/ccpa-access-delete.html)
         + [Supporto per il California Consumer Privacy Act: Rinuncia alla vendita da parte del consumatore](https://experienceleague.adobe.com/docs/advertising-cloud/privacy/ccpa/ccpa-opt-out-of-sale.html)
   + Criteri e linee guida {#policies}
      + [Criteri per i requisiti degli annunci](https://experienceleague.adobe.com/docs/advertising-cloud/policies/ad-requirements-policy.html)
      + [Linee guida accettabili per i segmenti di stato](https://experienceleague.adobe.com/docs/advertising-cloud/policies/health-segment-guidelines.html)
      + [[!DNL DSP] Linee guida sull’utilizzo dei dati](https://experienceleague.adobe.com/docs/advertising-cloud/policies/data-usage-guidelines.html)
   + [Soluzioni di misurazione avanzate](/help/dsp/introduction/advanced-measurement-services.md)
+ Campaign Management {#campaign-management}
   + [Panoramica della struttura di Campaign Management](/help/dsp/campaign-management/campaign-management-overview.md)
   + Campagne {#campaigns}
   ...
   + Pacchetti {#packages}
      ...
      + [Visualizza il registro delle modifiche per un pacchetto](/help/dsp/campaign-management/packages/package-change-log.md)
   ...
   + Posizionamenti {#placements}
      ...
      + [Modifica rapida delle impostazioni di posizionamento chiave](/help/dsp/campaign-management/placements/placement-quick-edit.md)
      + [Duplicare un posizionamento](/help/dsp/campaign-management/placements/placement-duplicate.md)
      + [Allega un annuncio a un posizionamento](/help/dsp/campaign-management/ads/ad-attach-to-placement.md)
      ...
      + [Visualizza il registro delle modifiche per un posizionamento](/help/dsp/campaign-management/placements/placement-change-log.md)
      + [Mettere in pausa o attivare un posizionamento](/help/dsp/campaign-management/placements/placement-pause-activate.md)
   ...
   + Annunci {#ads}
      ...
      + [Partner certificati di Ad Serving](/help/dsp/campaign-management/ads/certified-ad-servers.md)
      ...
      + [Allega un annuncio a un posizionamento](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/campaign-management/placements/ad-attach-to-placement.html)<!-- Dupe link to this file (in Placements chapter), so need to use an absolute link in one of the listings -->
      ...
      + Impostazioni annuncio {#ad-settings}
         ...
         + [Impostazioni annunci di visualizzazione native](/help/dsp/campaign-management/ads/ad-settings-native.md)
   ...
   + Report delle campagne {#campaign-reports}
      + [Informazioni sui report in-Platform](/help/dsp/campaign-management/reports/campaign-reports-about.md)
      + [Esportare dati da una visualizzazione Campaign Management](/help/dsp/campaign-management/reports/campaign-export-data.md)
      ...
      + [Visualizzare i rapporti diagnostici di posizionamento](/help/dsp/campaign-management/reports/placement-diagnostics.md)
      + Gestire le visualizzazioni dati {#data-views}
         + [Informazioni sulle visualizzazioni dati di Campaign](/help/dsp/campaign-management/reports/campaign-data-views-about.md)
         + [Modificare la Vista a colonne](/help/dsp/campaign-management/reports/column-view-change.md)
         + [Creare una vista a colonne personalizzata](/help/dsp/campaign-management/reports/column-view-create.md)
...
+ Ottimizzazione {#optimization}
   ...
   + [Filtri di pre-offerta a livello di posizionamento e modalità di utilizzo](/help/dsp/optimization/optimization-pre-bid-filters.md)
...
+ Tipi di pubblico {#audiences}
   ...
   + Gestisci audience {#reusable-audiences}
      ...
      + [Visualizzare i dettagli su un pubblico riutilizzabile](/help/dsp/audiences/reusable-audience-view-details.md)
      ...
      + [Copia negli Appunti la chiave di segmento per un pubblico riutilizzabile](/help/dsp/audiences/reusable-audience-clipboard.md)
   ...
   + [Fornitori di dati di terze parti disponibili](/help/dsp/audiences/third-party-data-providers.md)
+ Inventario {#inventory}
   + [Panoramica delle funzionalità di inventario](/help/dsp/inventory/inventory-overview.md)
   + [Utilizzo [!DNL Roku Inventory]](/help/dsp/inventory/roku-inventory.md)
   + [Partner SSP](/help/dsp/inventory/ssp-partners.md)
   + [!DNL On Demand] Inventario {#on-demand}
      + [Informazioni [!DNL On Demand] Inventario Premium](/help/dsp/inventory/on-demand-inventory-about.md)
      + Disponibile [!DNL On Demand] Editori di inventario Premium {#publishers}
         + [[!DNL On Demand] Editori Premium di Inventario in Asia Pacifico](/help/dsp/inventory/on-demand-inventory-publishers-apac.md)
         + [[!DNL On Demand] Editori Premium di Inventario in Australia e Nuova Zelanda](/help/dsp/inventory/on-demand-inventory-publishers-anz.md)
         + [[!DNL On Demand] Editori Premium di Inventario in Europa, Medio Oriente e Africa](/help/dsp/inventory/on-demand-inventory-publishers-emea.md)
         + [[!DNL On Demand] Editori Premium di Inventario in Nord America](/help/dsp/inventory/on-demand-inventory-publishers-na.md)
      ...
      + [Richiedi nuovamente [!DNL On Demand] Offerte di magazzino Premium](/help/dsp/inventory/on-demand-inventory-rerequest.md)
      + [Visualizza lo stato del [!DNL On Demand] Richieste di offerte e abbonamenti](/help/dsp/inventory/on-demand-inventory-view-status.md)
   + Inventario privato {#private-inventory}
      + [Informazioni su Inventario privato](/help/dsp/inventory/private-inventory-about.md)
      + ID offerta {#deal-ids}
         + [!UICONTROL Deal ID Inbox] {#inbox}
            + [Informazioni sul [!UICONTROL Deal ID Inbox]](/help/dsp/inventory/deal-id-inbox-about.md)
            + [Accettare un accordo nel [!UICONTROL Deal ID Inbox]](/help/dsp/inventory/deal-id-inbox-accept.md)
         + ID offerta inseriti manualmente {#manual}
            + [Creare manualmente [!UICONTROL Deal ID] Dettagli](/help/dsp/inventory/deal-id-create.md)
            + [Manuale [!UICONTROL Deal ID] Impostazioni](/help/dsp/inventory/deal-id-settings.md)
         + Offerte garantite programmatiche {#programmatic-guaranteed-deal}
            + [Panoramica delle offerte garantite programmatiche](/help/dsp/inventory/programmatic-guaranteed-about.md)
            + [Suggerimenti per negoziare un accordo programmatico garantito](/help/dsp/inventory/programmatic-guaranteed-tips.md)
            + [Imposta un accordo garantito programmatico](/help/dsp/inventory/programmatic-guaranteed-set-up.md)
            + [!DNL FreeWheel] Offerte garantite programmatiche {#freewheel}
               ...
               + [Codici di errore per gli invii di annunci FreeWheel](/help/dsp/inventory/freewheel-error-codes.md)
      + [Modifica impostazioni offerte private](/help/dsp/inventory/deal-id-edit.md)
      + [Specificare posizionamenti e annunci per un&#39;offerta privata](/help/dsp/inventory/deal-id-attach-placements.md)
      + [Modificare gli account con accesso a un&#39;offerta privata](/help/dsp/inventory/deal-id-share.md)
      + [Modificare gli inserzionisti con accesso a un’offerta privata](/help/dsp/inventory/deal-id-edit-advertisers.md)
   ...
   + [!UICONTROL Simple Ad Serving] Offerte {#sas}
      + [Informazioni [!UICONTROL Simple Ad Serving]](/help/dsp/inventory/simple-deal-about.md)
      + [Crea un [!UICONTROL Simple Ad Serving] Offerta](/help/dsp/inventory/simple-deal-create.md)
      + [Modifica [!UICONTROL Simple Ad Serving] Impostazioni offerte](/help/dsp/inventory/simple-deal-edit.md)
      + [[!UICONTROL Simple Ad Serving] Impostazioni offerte](/help/dsp/inventory/simple-deal-settings.md)
   + [Visualizzare un rapporto dettagliato di un&#39;offerta](/help/dsp/inventory/deal-view-report.md)
+ Report personalizzati {#custom-reports}
...
+ Amministrazione {#admin}
   + [Modificare il profilo](/help/dsp/admin/user-own-profile-edit.md)
   + Utenti {#users}
      + [Invitare un nuovo utente](/help/dsp/admin/user-invite.md)
      + [Invia nuovamente un invito utente in sospeso](/help/dsp/admin/user-resend-invite.md)
      + [Annullare l’invito di un utente in sospeso](/help/dsp/admin/user-uninvite.md)
   + Siti bloccati {#sites}
   ...
   + Notifiche {#notifications}
      ...
      + [Gestire sottoscrizioni di avvisi](/help/dsp/admin/alerts-manage.md)
+ [Integrazioni con Adobe Experience Cloud](https://experienceleague.adobe.com/docs/advertising-cloud/integrations/home.html)<!-- Dupe link to this file, so need to use an absolute link in one of the listings -->

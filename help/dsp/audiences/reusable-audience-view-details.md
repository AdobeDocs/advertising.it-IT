...
1. (Facoltativo) Per visualizzare il numero di membri del pubblico attivi o totali per tipo di dispositivo, fai clic su ![Guasto del dispositivo](/help/dsp/assets/device-breakdown.png) accanto al **[!UICONTROL Active]** o **[!UICONTROL Total]** dimensione del pubblico.

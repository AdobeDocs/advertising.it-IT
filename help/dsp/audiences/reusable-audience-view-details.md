---
title: Visualizzare i dettagli di un pubblico riutilizzabile
...
# Visualizzare i dettagli di un pubblico riutilizzabile
...
1. (Facoltativo) Per visualizzare il numero di membri del pubblico attivi per tipo di dispositivo (per ID basati su cookie) e per tipo di ID universale, fai clic su ![Raggruppamento dispositivo](/help/dsp/assets/device-breakdown.png) accanto alla dimensione del pubblico.

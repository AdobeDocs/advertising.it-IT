...
È possibile scaricare un file del foglio di lavoro [!DNL Microsoft Excel] con la regola di configurazione del pubblico, il numero di membri del pubblico attivi per tipo di dispositivo, i dettagli di ogni segmento del pubblico e tutti i posizionamenti mirati al pubblico.

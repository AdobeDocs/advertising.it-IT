...
---
# Dati necessari per aggiungere, aggiornare ed eliminare record

Nella tabella seguente vengono illustrati i campi obbligatori, facoltativi o non applicabili quando si aggiunge, si modifica o si elimina ogni tipo di record di componente. Quando un campo non è applicabile all’azione, qualsiasi valore inserito nel campo viene ignorato.

...
**[!UICONTROL Campaign Priority]:** (Solo campagne commerciali; sola lettura per le campagne esistenti) La priorità con cui viene utilizzata la campagna quando più campagne pubblicizzano lo stesso prodotto: *[!UICONTROL Low]* (impostazione predefinita per le nuove campagne), *[!UICONTROL Medium]*, o *[!UICONTROL High]*.

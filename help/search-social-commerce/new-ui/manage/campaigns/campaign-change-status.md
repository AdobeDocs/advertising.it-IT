---
title: (Nuova interfaccia) Modificare lo stato di una campagna
description: Scopri come modificare lo stato di una campagna senza aprirne le impostazioni.
...
# (Nuova interfaccia) Modificare lo stato di una campagna

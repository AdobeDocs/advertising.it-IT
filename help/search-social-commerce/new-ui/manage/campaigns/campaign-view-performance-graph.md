---
title: (Nuova interfaccia) Visualizzazione di un grafico delle prestazioni nella visualizzazione [!UICONTROL Campaigns]
description: Scopri come aprire e configurare un grafico delle prestazioni nella visualizzazione [!UICONTROL Campaigns].
...
# (Nuova interfaccia) Visualizzazione di un grafico delle prestazioni nella visualizzazione [!UICONTROL Campaigns]

*funzionalità Beta*

Puoi aprire e configurare un grafico delle prestazioni con un massimo di tre metriche totali per tutte le campagne nella vista per l’intervallo di date specificato.

...
**[!UICONTROL Campaign Type]:** Dove inserire annunci e quali tipi di annunci può contenere la campagna:
...
Per le campagne di ricerca, sono necessarie anche le seguenti impostazioni aggiuntive per i consigli:

* obiettivo strategia di offerta
* paese
* lingua
* una posizione inclusa o esclusa
* parole chiave
...
* *[!UICONTROL Enhanced CPC]:* Obsoleto. [!DNL Google Ads] ha iniziato a modificare automaticamente le [strategie di offerta CPC migliorate](https://support.google.com/google-ads/answer/2464964) esistenti in CPC manuali nel 2025.
...
* *[!UICONTROL Maximize Conversion Value]:* (campagne Search, Performance Max e Smart Shopping) La rete di annunci, non Search, Social e Commerce, ottimizza le offerte per massimizzare il valore di conversione. È possibile immettere un valore **[!UICONTROL Target Return on Ad Spend]** (ROAS) come percentuale. **Nota:** utilizza questa opzione per le campagne in portfolio con ottimizzazione a livello di campagna o di gruppo di annunci, ma non per i portfolio con ottimizzazione a livello di parola chiave. Nei portfolio con ottimizzazione a livello di campagna o di gruppo di annunci, Search, Social e Commerce ottimizzano il ROAS di Target a livello di campagna o (se disponibile) di gruppo di annunci.

* *[!UICONTROL Maximize Conversions]:* (campagne Search, Display e Performance Max) La rete di annunci, non Search, Social e Commerce, ottimizza le offerte per massimizzare le conversioni. Facoltativamente, immettere un **[!UICONTROL Target CPA]** (costo per acquisizione) e la strategia di offerta **[!UICONTROL Portfolio]** applicabile. **Nota:** utilizza questa opzione per le campagne in portfolio con ottimizzazione a livello di campagna o di gruppo di annunci, ma non per i portfolio con ottimizzazione a livello di parola chiave. Nei portfolio con ottimizzazione a livello di campagna o di gruppo di annunci, Search, Social e Commerce ottimizzano il CPA di Target a livello di campagna o (se disponibile) di gruppo di annunci.

* *[!UICONTROL Target CPA]:* (campagne di sola visualizzazione) La rete di annunci, non Search, Social e Commerce, ottimizza le offerte in base a un **[!UICONTROL Target CPA]** facoltativo (costo per acquisizione), che è l&#39;importo medio di 30 giorni che si desidera pagare per un&#39;acquisizione (conversione). **Nota:** campagne in portfolio con ottimizzazione a livello di campagna o di gruppo di annunci (ma non in portfolio con ottimizzazione a livello di parola chiave) con qualsiasi strategia di spesa eccetto [!UICONTROL Weekly] o [!UICONTROL Google Target CPA]. Nei portfolio con ottimizzazione a livello di campagna o di gruppo di annunci, Search, Social e Commerce ottimizzano il CPA di Target a livello di campagna o (se disponibile) di gruppo di annunci.
...
* *[!UICONTROL Target Return on Ad Spend]:* (campagne acquisti) La rete di annunci, non Search, Social e Commerce, ottimizza le offerte in base a un **[!UICONTROL Target ROAS]** specificato (ritorno sulla spesa pubblicitaria), specificato come percentuale. **Nota:** utilizza questa opzione per le campagne in portfolio con ottimizzazione a livello di campagna o di gruppo di annunci (ma non in portfolio con ottimizzazione a livello di parola chiave) con qualsiasi strategia di spesa eccetto [!UICONTROL Weekly] o [!UICONTROL Google Target ROAS]. Nei portfolio con ottimizzazione a livello di campagna o di gruppo di annunci, Search, Social e Commerce ottimizzano il ROAS di Target a livello di campagna o (se disponibile) di gruppo di annunci.
...
## Scheda [!UICONTROL Shopping Settings]
...
## Scheda [!UICONTROL Advanced Device Options]
...
## Scheda [!UICONTROL AI Max]

*Campagne mirate solo alla rete di ricerca*

**[!UICONTROL AI Max]:** se abilitare [[!UICONTROL AI Max]](https://support.google.com/google-ads/answer/15910366) — corrispondenza dei termini di ricerca basata su IA, personalizzazione del testo ed espansione dell&#39;URL finale — per la campagna. Quando abiliti **[!UICONTROL AI Max]**, diventano disponibili due impostazioni aggiuntive:

* **[!UICONTROL Text customization]:** se consentire a [!DNL Google Ads] di utilizzare l&#39;intelligenza artificiale generativa per personalizzare la copia degli annunci, i titoli e le descrizioni in base agli annunci esistenti e alla copia della pagina di destinazione.

* **[!UICONTROL Final URL expansion]:** se consentire a [!DNL Google Ads] di instradare il traffico alla pagina di destinazione più pertinente del sito Web in base al loro intento di ricerca. Questa impostazione è disponibile solo quando **[!UICONTROL Text customization]** è abilitato.

<!-- Clarify why this is "Unspecified" and read-only for me as of 7/23. Also, shouldn't we reword this? -->

**[!UICONTROL Bundling required]:** (Solo campagne esistenti con la funzionalità [!UICONTROL AI Max] abilitata; sola lettura) Indica se [!UICONTROL AI Max] deve essere abilitato per rispettare o modificare la personalizzazione del testo e i controlli dell&#39;elenco dei marchi per la campagna: *[!UICONTROL Required]*, *[!UICONTROL Not required]* o *[!UICONTROL Unspecified]*.

<!-- Is this based on the advanced location options set elsewhere in Google Ads editor? -->

**[!UICONTROL Geo Targeting Type]:** (Solo campagne esistenti con la funzionalità [!UICONTROL AI Max] abilitata; sola lettura) Quando uno dei gruppi di annunci della campagna include [!UICONTROL Locations of Interest] destinazioni, i tipi di interesse utente di destinazione sono indicati: *[!UICONTROL Search Interest]* (utenti interessati a una posizione specificata), *[!UICONTROL Presence]* (utenti in o regolarmente in una posizione specificata) o *[!UICONTROL Presence or Interest]* (utenti in, regolarmente in o interessati a una posizione specificata).
...
*Solo campagne con prestazione massima*
...
**[!UICONTROL Final URL]:** URL finale per tutti gli annunci creati dal gruppo di risorse. <!-- For campaigns created within Search, Social, & Commerce, final URL expansion is automatically enabled for the campaign, and [!DNL Google Ads] replaces this value with a more relevant landing page based on the user's search query and intent, and also customizes the headline based on the landing page content. You can disable final URL expansion, or exclude specific URLs from expansion, from within the [!DNL Google Ads] editor. -->

**[!UICONTROL Images]:** Fino a 15 immagini per l&#39;annuncio, inclusa almeno un&#39;immagine orizzontale (1.91:1, almeno 600 x 314 pixel) e almeno un&#39;immagine quadrata (1:1, almeno 300 x 300 pixel). È possibile includere un&#39;immagine di ritratto (4:5, almeno 480 x 600 pixel). Consulta le [[!DNL Google Ads] specifiche immagine](https://support.google.com/google-ads/answer/10724492?hl=en&ref_topic=10631992#zippy=,audience-signal-inputs,video-specifications,image-specifications). È possibile caricare immagini o selezionarle da [!UICONTROL Asset Library], ma non entrambe nella stessa operazione.
...
**[!UICONTROL Logos]:** almeno un logo quadrato (1:1, almeno 128 x 128 pixel). Facoltativamente, puoi includere un logo orizzontale (4:1, almeno 512 x 218 pixel). È possibile includere fino a cinque logo in totale. Consulta le [[!DNL Google Ads] specifiche del logo](https://support.google.com/google-ads/answer/10724492?hl=en&ref_topic=10631992#zippy=,audience-signal-inputs,video-specifications,image-specifications). È possibile caricare immagini o selezionarle da [!UICONTROL Asset Library], ma non entrambe nella stessa operazione.
...
Ottimizza la tua campagna per nuovi clienti, clienti esistenti o entrambi. Per utilizzare questa impostazione, è innanzitutto necessario attivare il nuovo obiettivo di acquisizione cliente per l&#39;account [!DNL Google Ads] o, se applicabile, per l&#39;account manager. L’obiettivo definisce gli elenchi dei clienti esistenti idonei e il valore di conversione aggiuntivo per i nuovi clienti nelle impostazioni di conversione. Consulta i passaggi 1-2 nella guida di [!DNL Google Ads] &quot;[Attiva il nuovo obiettivo di acquisizione clienti](https://support.google.com/google-ads/answer/14007601).&quot;

**[!UICONTROL Customer Goal]:** Tipo di obiettivo di acquisizione cliente:

* *[!UICONTROL All Customers]* (impostazione predefinita): ottimizzazione equa sia per i clienti nuovi che per quelli esistenti.

* *[!UICONTROL New Customers]:* Dai priorità all&#39;acquisizione di nuovi clienti. Selezionando questa opzione viene visualizzata l&#39;impostazione **[!UICONTROL New Customer Bid Adjustment]**.

* *[!UICONTROL Existing Customers]:* Assegna la priorità alla conservazione dei clienti esistenti.

**[!UICONTROL New Customer Bid Adjustment]:** (**[!UICONTROL Customer Goal]** impostato solo su **[!UICONTROL New Customers]**) Un moltiplicatore applicato alle offerte quando si esegue il targeting di nuovi clienti, da 0,1 a 10,0. Il valore di default è 1.0 (nessuna regolazione). Ad esempio, 1,5x aumenta le offerte del 50% per i nuovi clienti, 2,0x raddoppia le offerte per i nuovi clienti e 0,5x riduce le offerte del 50% per i nuovi clienti.

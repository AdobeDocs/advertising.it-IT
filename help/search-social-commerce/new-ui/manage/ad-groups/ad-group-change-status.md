---
title: (Nuova interfaccia) Modificare lo stato di un gruppo di annunci
description: Scopri come modificare lo stato di un gruppo di annunci senza aprire le impostazioni del gruppo di annunci.
...
# (Nuova interfaccia) Modificare lo stato di un gruppo di annunci
...
1. Effettuare una delle seguenti operazioni:
   ...
   * Posizionare il cursore sulla riga del gruppo camad e fare clic su ![Modifica](/help/search-social-commerce/assets/edit.png "Modifica") accanto alla colonna [!UICONTROL Status]. Selezionare **[!UICONTROL Deleted]**.

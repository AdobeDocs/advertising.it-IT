---
title: (Nuova interfaccia) Modificare lo stato di un annuncio
description: Scopri come modificare lo stato di un annuncio senza aprirne le impostazioni.
...
# (Nuova interfaccia) Modificare lo stato di un annuncio
...
>[!MORELIKETHIS]
>
>* [(Nuova interfaccia) Informazioni sulla visualizzazione [!UICONTROL Ads]](ad-view-about.md)

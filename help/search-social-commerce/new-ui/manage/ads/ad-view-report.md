...
# (Nuova interfaccia) Gestisci i report di visualizzazione dati dalla visualizzazione [!UICONTROL Ads]

*funzionalità Beta*

È possibile generare un report che includa le righe di dati per uno o più annunci nella visualizzazione [!UICONTROL Ads] e quindi scaricare il report come file del foglio di lavoro di Microsoft Excel (formato XLXS). Il report include tutte le colonne visibili nella visualizzazione.

...
* Contatta il team del tuo account Adobe per configurare un account FTP per l&#39;accesso ai rapporti.

  Il team ti fornirà nome utente e password.

## Configurare modelli di rapporto per la consegna FTP

Per generare report nella directory FTP designata, crea un [modello di report](report-templates-manage.md) con le seguenti convenzioni di denominazione e pianificazione.
...
>[!MORELIKETHIS]
>
>* [Gestisci modelli di report](/help/search-social-commerce/new-ui/reports/report-templates-manage.md)

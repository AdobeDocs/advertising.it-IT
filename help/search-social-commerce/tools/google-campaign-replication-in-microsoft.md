...
Puoi esportare le campagne sincronizzate in una [!DNL Google Ads] account direttamente in un file sincronizzato [!DNL Microsoft Advertising] account come campagne CPC (eCPC) avanzate. Le offerte e i budget delle campagne esistenti vengono scalati. Il tracciamento di ricerche, social network e Commerce esistente non viene importato.
...
* [!DNL Google Ads] le campagne con le massime prestazioni, inclusi gli annunci di inventario locali, in [!DNL Microsoft Advertising] numero massimo di campagne con prestazioni.
...
1. Nel menu principale Ricerca, Social e Commerce, fai clic su **[!UICONTROL Search]> [!UICONTROL Tools] >[!UICONTROL Import Campaigns]**.
...
Generazione automatica di [!DNL Microsoft Advertising] credenziali per l&#39;importazione non disponibili a causa di [!DNL Microsoft Advertising] limitazioni. Contatta il tuo Account Team di Adobi, che genererà le credenziali e ti fornirà l’ID.

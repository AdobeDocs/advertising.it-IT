...
description: Scopri gli strumenti per creare i tag di tracciamento delle conversioni e i tag di tracciamento dei clic di Adobe Advertising Search, Social e Commerce, e come decodificare i tag di tracciamento dei clic esistenti.
...
* Lo strumento [[!UICONTROL Conversion Tags]](conversion-tag-generate.md) ti consente di generare manualmente i tag di tracciamento delle conversioni di Adobe Advertising da aggiungere alle pagine di successo o di ringraziamento sui tuoi siti Web.

  >[!NOTE]
  >
  >Il team dell’account di Adobe in genere fornisce tag di tracciamento delle conversioni di Adobe, pertanto potresti non aver bisogno di questa funzione.
...
>[!MORELIKETHIS]
>
>* [Generare un tag di conversione Adobe Advertising](conversion-tag-generate.md)

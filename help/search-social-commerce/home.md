...
| ---- | ------- | ----------- | -------------------- |
| 30 giugno 2023 | [!UICONTROL Asset Library] | (Funzione beta) In [!UICONTROL Campaigns] > [!UICONTROL Asset Library (Beta)], puoi creare risorse di immagine, video e testo riutilizzabili e caricarle nel tuo [!DNL Google] libreria di risorse a livello di account. Puoi utilizzare le risorse per gli annunci quando crei o modifichi campagne all’interno di [!DNL Google Ads] editor. | Consulta &quot;[Creare e caricare le risorse](/help/search-social-commerce/campaign-management/asset-library/asset-create.md).&quot; |

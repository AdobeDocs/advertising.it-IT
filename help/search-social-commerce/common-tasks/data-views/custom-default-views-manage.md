...
1. Salva la visualizzazione:
   ...
   * Per salvare le modifiche e applicarle, fare clic su **[!UICONTROL Apply]**.<!-- Should be Save & Apply -->
...
* Dalla nuova interfaccia utente:
   ...
   1. Posizionare il cursore sul nome della visualizzazione e fare clic su ![Ripristina](/help/search-social-commerce/assets/revert-new.md).

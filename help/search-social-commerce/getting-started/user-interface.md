...
* Sopra il menu principale a sinistra, fai clic su ![Comprimi/espandi](/help/search-social-commerce/assets/collapse-expand.png "Comprimi/espandi").
...
* **[!UICONTROL Search, Social, & Commerce]** \> - Consente di gestire gli account di rete pubblicitaria in Search, Social e Commerce, inclusi gli account di cui Search, Social e Commerce tiene traccia ma per i quali non vengono presentate offerte.

## [!UICONTROL Search] menu

L&#39;opzione [!UICONTROL Search] include i sottomenu seguenti. Il tuo ruolo determina le opzioni disponibili:

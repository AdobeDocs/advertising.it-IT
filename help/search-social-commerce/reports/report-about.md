...
* Genera automaticamente report ogni giorno oppure in un giorno specifico della settimana o del mese, utilizzando [modelli di report](/help/search-social-commerce/reports/automation/templates/template-about.md).
  ...
  Facoltativamente puoi impostare [la consegna FTP di rapporti di base e avanzati](/help/search-social-commerce/reports/automation/ftp-reports.md) che utilizzano un modello.

* Continua ad aggiornare i tuoi modelli di foglio di calcolo personalizzati con i dati sulle prestazioni giornaliere utilizzando [feed di foglio di calcolo](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-about.md).

## Visualizzazioni dei report

Le visualizzazioni [!UICONTROL Reports] in [!UICONTROL Search] > [!UICONTROL Insights & Reports] > [!UICONTROL Reports] consentono di creare e gestire report, modelli e feed di fogli di calcolo. La vista include due schede:
...
| Identificazione delle opportunità di crescita del business | <ul><li>(Solo per gli inserzionisti con Adobe Advertising di tracciamento delle conversioni) [The [!UICONTROL Geo Distribution Report]](/help/search-social-commerce/reports/management/basic-advanced/geo-distribution-report.md)</li><li>(Solo per gli inserzionisti con Adobe Advertising di tracciamento delle conversioni) [The [!UICONTROL Domain Referral Report]](/help/search-social-commerce/reports/management/basic-advanced/domain-referral-report.md)</li><li>(Inserzionisti con [Adobe [!DNL Analytics for Advertising]](https://experienceleague.adobe.com/docs/advertising/integrations/analytics/overview.html?lang=it)) Rapporti personalizzati in Adobe Analytics Analysis Workspace</li></ul> |
| Analytics | <ul><li>(Solo per gli inserzionisti con Adobe Advertising di tracciamento delle conversioni) [The [!UICONTROL Channel Assist Report]](/help/search-social-commerce/reports/management/assist/channel-assist-report.md)</li><li>(Inserzionisti con [Adobe [!DNL Analytics for Advertising]](https://experienceleague.adobe.com/docs/advertising/integrations/analytics/overview.html?lang=it)) Rapporti personalizzati in Adobe Analytics Analysis Workspace</li></ul> |

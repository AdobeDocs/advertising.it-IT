...
| [!UICONTROL Specialty Reports] | [I report speciali](/help/search-social-commerce/reports/management/specialty/specialty-report-about.md) sono costituiti da dati raccolti dalle reti di annunci (anziché dal tracciamento di Adobe Advertising). |
...
Le visualizzazioni [!UICONTROL Reports] in [!UICONTROL Search, Social, & Commerce] > [!UICONTROL Insights & Reports] > [!UICONTROL Reports] consentono di creare e gestire report, modelli e feed di fogli di calcolo. La vista include due schede:

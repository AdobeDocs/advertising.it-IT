...
| [!UICONTROL Account Number] | ([!UICONTROL MSA Ad Extension] report) L&#39;identificatore dell&#39;account assegnato dalla rete di annunci. |
| [!UICONTROL Account Status] | ([!UICONTROL MSA Ad Extension] report) Stato account: *[!UICONTROL Active]*, *[!UICONTROL Paused]* o *[!UICONTROL Inactive]*. |
| [!UICONTROL Ad Distribution] | ([!UICONTROL Bing Ads Geo Report], [!UICONTROL MSA Network Impression Share Report] e [!UICONTROL MSA Network Performance Report]) Dove è stato distribuito l&#39;annuncio: *[!UICONTROL Audience]* (sulla rete del pubblico)*,[!UICONTROL Search]* (sulle pagine dei risultati di ricerca) o *[!UICONTROL Content]* (sui siti Web di proprietà di [!DNL Microsoft] o sui siti Web partner partecipanti). |
| [!UICONTROL Ad Extension ID] | ([!UICONTROL MSA Ad Extension] report) ID per l&#39;estensione dell&#39;annuncio. |
...
| [!UICONTROL Conversions Value] | ([!UICONTROL Google AI Max Search Term Combination Report]) Il valore di tutte le conversioni da azioni di conversione per le quali è abilitato &quot;Includi nelle conversioni&quot;. |
| [!UICONTROL Conversions Value Per Cost] | ([!UICONTROL Google AI Max Search Term Combination Report]) Il valore di tutte le conversioni diviso per il costo totale delle interazioni pubblicitarie (ad esempio clic o visualizzazioni video). Sono incluse solo le conversioni da azioni di conversione per le quali è abilitato &quot;Includi nelle conversioni&quot;. |
...
| [!UICONTROL Cost Per All Conversions] | ([!UICONTROL Google AI Max Search Term Combination Report]) Il costo delle interazioni pubblicitarie diviso per tutte le conversioni. |
| [!UICONTROL Cost Per Assist] | ([!UICONTROL MSA Ad Extension] report) Il costo totale per assistenza. |
| [!UICONTROL Cost Per Conversion] | ([!UICONTROL Google AI Max Search Term Combination Report] e [!UICONTROL MSA Ad Extension] report) Il costo delle interazioni pubblicitarie diviso per le conversioni. Per Google Ads, sono incluse solo le conversioni da azioni di conversione per le quali è abilitato &quot;Includi nelle conversioni&quot;. |
...
| [!UICONTROL Display Name] | ([!UICONTROL Google Performance Max Placement Report]) Il nome visualizzato nel posizionamento, ad esempio l&#39;URL del sito Web, il nome dell&#39;app mobile o il nome di un video [!DNL YouTube]. |
...
| [!UICONTROL Headline 1] | ([!UICONTROL Google AI Max Search Term Combination Report]) Il primo titolo dell&#39;annuncio. |
| [!UICONTROL Headline 2] | ([!UICONTROL Google AI Max Search Term Combination Report]) Secondo titolo dell&#39;annuncio. |
...
| [!UICONTROL Landing Page] | ([!UICONTROL Google AI Max Search Term Combination Report]) Pagina di destinazione dell&#39;annuncio. |
...
| [!UICONTROL Path2] | ([!UICONTROL Google Asset Group Performance Report]) Secondo set di testo che può essere aggiunto all&#39;URL di visualizzazione nell&#39;annuncio. Questo campo è disponibile solo quando viene specificato un valore Path1. |
| [!UICONTROL Placement] | ([!UICONTROL Google Performance Max Placement Report]) Nome del posizionamento. |
| [!UICONTROL Placement Type] | ([!UICONTROL Google Performance Max Placement Report]) Tipo di posizionamento in cui è stato distribuito l&#39;annuncio: *[!UICONTROL Mobile App]*, *[!UICONTROL YouTube Video]* (l&#39;annuncio è apparso in un video [!DNL YouTube] o in un video *[!UICONTROL Webpage]* adiacente). |
...
| [!UICONTROL Portfolio Spend Strategy] | (Rapporto Portfolio) Strategia di spesa per il portfolio: *[!UICONTROL Daily]*, *[!UICONTROL Weekly]*, *[!UICONTROL Monthly]*, *[!UICONTROL ROI]*, *[!UICONTROL Day of week]*, *[!UICONTROL Day of month]*, *[!UICONTROL CPT]*, *[!UICONTROL Marginal CPT]*, *[!UICONTROL Google Target CPA]* o *[!UICONTROL Google Target ROAS]*. |
...
| [!UICONTROL Search impr. share] | ([!DNL Google Ads] solo; [!UICONTROL Campaign Daily Impression Share Report] e [!UICONTROL Keyword Daily Impression Share Report]) Le impression ricevute si dividono per il numero stimato di impression che si potevano ricevere. Le percentuali inferiori al 10% sono indicate come &quot;`<10%`&quot; e le percentuali superiori al 90% sono indicate come &quot;`>90%`&quot;. |
...
| [!UICONTROL Search Term] | ([!UICONTROL AdWords Search Query Report], [!UICONTROL Bing Ads Search Query Report] e [!UICONTROL Google AI Max Search Term Combination Report]) Termine di ricerca utente da cui si sono originati i clic. |
...
| [!UICONTROL Target URL] | ([!UICONTROL Google Performance Max Placement Report]) URL per il posizionamento, ad esempio un sito Web o un collegamento a un&#39;app mobile in un app store oppure URL per un video [!DNL YouTube]. |
...
| [!UICONTROL Value Per All Conversions] | ([!UICONTROL Google AI Max Search Term Combination Report]) Il valore di tutte le conversioni diviso per il numero di tutte le conversioni. |
| [!UICONTROL Value Per Conversion] | ([!UICONTROL Google AI Max Search Term Combination Report]) Il valore delle conversioni diviso per il numero di conversioni. Sono incluse solo le conversioni da azioni di conversione per le quali è abilitato &quot;Includi nelle conversioni&quot;. |

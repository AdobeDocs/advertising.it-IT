...
Dall’elenco delle metriche rese disponibili, ogni utente con accesso ai dati dell’inserzionista può personalizzare le metriche visualizzate per le visualizzazioni e i rapporti di gestione includendo o omettendo metriche specifiche. Gli utenti con privilegi di accesso sufficienti possono inoltre ottimizzare per metriche specifiche associandole a portfolio o a obiettivi personalizzati a livello di pacchetto di DSP.

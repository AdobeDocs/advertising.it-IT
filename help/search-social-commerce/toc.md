      ...
      + Rapporti pianificati {#scheduled}
         ...
         + Tipi di rapporti pianificati {#report-types}
            ...
            + Rapporti di assistenza {#assist-reports}
               + [Informazioni sui rapporti di assistenza](/help/search-social-commerce/new-ui/reports/management/assist/assist-report-about.md)
      ...
      + Gestione dei dati nelle visualizzazioni [!UICONTROL Campaigns] > [!UICONTROL Campaigns] {#campaigns}
         ...
         + Parole chiave {#keywords}
            ...
            + Impostazioni delle parole chiave per rete di annunci {#keyword-settings-by-network}
               ...
               + [[!DNL LY Ads] impostazioni parola chiave](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)

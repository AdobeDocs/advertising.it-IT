...
+ (Beta) NUOVA INTERFACCIA UTENTE {#new-ui}
   ...
   + Gestisci {#manage}
      + Portafogli {#portfolios}
         ...
         + [Rinominare un portfolio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-rename.md)
         + [Modificare lo stato di un portfolio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-change-status.md)
         + [Impostazioni Portfolio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-settings.md)
         + [Eseguire una simulazione personalizzata dalla visualizzazione [!UICONTROL Portfolios]](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-create-simulation.md)
         + [Visualizzare un grafico delle prestazioni nella visualizzazione [!UICONTROL Portfolios]](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-view-performance-graph.md)
      ...
      + Campagne {#campaigns}
         ...
         + [Assegnare campagne a un portfolio](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/campaign-assign-to-portfolio){target="_blank"}
         + [Rimuovere campagne da un portfolio](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/campaign-remove-from-portfolio){target="_blank"}
         ...
         + [Modificare lo stato di una campagna](/help/search-social-commerce/new-ui/manage/campaigns/campaign-change-status.md)
         + [Rinominare una campagna](/help/search-social-commerce/new-ui/manage/campaigns/campaign-rename.md)
      + Gruppi di annunci {#ad-groups}
         ...
         + [Modificare lo stato di un gruppo di annunci](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-change-status.md)
         + [Rinominare un gruppo di annunci](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-rename.md)
      + Annunci {#ads}
   ...
   + Rapporti {#reports}
      + Rapporti pianificati {#scheduled}
         + [Le attività di configurazione iniziali per i rapporti](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/initial-setup){target="_blank"}
         + [Dati utilizzati per i rapporti](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/data-used-for-reports){target="_blank"}
         ...
         + Tipi di rapporti pianificati {#report-types}
            + Rapporti di base e avanzati {#basic-advanced-reports}
               ...
               + [Impostazioni di base e avanzate dei rapporti](/help/search-social-commerce/new-ui/reports/management/basic-advanced/basic-advanced-report-settings.md)
               + [Colonne di report per report di base e avanzati](/help/search-social-commerce/new-ui/reports/management/basic-advanced/basic-advanced-report-columns.md)
            + Rapporti di assistenza {#assist-reports}
               + [Informazioni sui report di assistenza](/help/search-social-commerce/new-ui/reports/management/assist/assist-report-about.md)
Assistere i formati dei report {#assist-report-formats}
                  + [Il [!UICONTROL Channel Assist Report]]/help/search-social-commerce/new-ui/reports/management/assist/channel-assist-report.md)
               ...
               + [Impostazioni dei rapporti di assistenza](/help/search-social-commerce/new-ui/reports/management/assist/assist-report-settings.md)
            + Rapporti speciali {#specialty-reports}
               + [Informazioni sui report speciali](/help/search-social-commerce/new-ui/reports/management/specialty/specialty-report-about.md)
               ...
               + [Impostazioni report speciali](/help/search-social-commerce/new-ui/reports/management/specialty/specialty-report-settings.md)
               + [Colonne report per report speciali](/help/search-social-commerce/new-ui/reports/management//specialty/specialty-report-columns.md)
            + Report di precisione modello {#model-accuracy-reports}
               + [Informazioni sui report di precisione dei modelli](/help/search-social-commerce/new-ui/reports/management/model-accuracy/model-accuracy-report-about.md)
   ...
   + Target {#target}
      + Parole chiave {#keywords}
         ...
         + [Gestire le assegnazioni di vincoli per le parole chiave](/help/search-social-commerce/new-ui/target/keywords/keyword-assignments-manage.md)
      + Posizionamenti {#placements}
         ...
         + [Gestire le assegnazioni di vincoli per i posizionamenti](/help/search-social-commerce/new-ui/target/placements/placement-assignments-manage.md)

...
user-guide-description: Questa guida descrive le principali funzioni, attività, impostazioni e altre risorse necessarie per gestire e ottimizzare le campagne di ricerca, social e e commerce ad e generare report su di esse.
...
+ Introduzione {#intro}
   ...
   + Integrazione con Adobe Experience Cloud {#integrations}
      ...
      + [Adobe [!DNL Analytics for Advertising] (collegamento)](https://experienceleague.adobe.com/docs/advertising/integrations/analytics/overview.html)
      + [Integrazione con Adobe Audience Manager (collegamento)](https://experienceleague.adobe.com/docs/advertising/integrations/audience-manager/overview.html)
   + [Supporto per la privacy del consumatore (collegamento)](https://experienceleague.adobe.com/docs/advertising/privacy/home.html)
   + [Criteri e linee guida (collegamento)](https://experienceleague.adobe.com/docs/advertising/policies/ad-requirements-policy.html)
...
+ Attività comuni {#common-tasks}
   ...
   + Personalizzare le visualizzazioni dati {#data-views}
      ...
      + Impostazioni vista ad hoc {#ad-hoc-settings}
         ...
         + [Modifica e ordina il set di colonne da [!UICONTROL Custom Columns] icona](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
         + [Bloccare e sbloccare una configurazione di colonna nelle visualizzazioni delle campagne](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-lock-unlock.md)
   ...
   + Gestione delle metriche personalizzate {#custom-metrics}
   ...
   + Attività comuni di navigazione, modifica e selezione {#navigation-editing-selection}
      ...
      + Download di dati nelle visualizzazioni di gestione {#download-data-views}
...
+ Tracciamento {#tracking}
   ...
   + Tracciamento dei clic {#click-tracking}
      ...
      + [Cookie di Adobe Advertising](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-advertising-cloud.html)
...
+ Gestione delle campagne {#campaign-management}
   + Introduzione {#campaign-management-intro}
      ...
      + [Dati di conversione di Google Ads in Search, Social e Commerce](/help/search-social-commerce/campaign-management/introduction/google-conversion-data.md)
   + Impostazione di account {#campaign-management-accounts}
      + Account di rete dell’annuncio {#ad-network-accounts}
         ...
         + [Aggiorna il codice di tracciamento s\_kwcid per un [!DNL Google Ads] account](/help/search-social-commerce/campaign-management/accounts/update-skwcid-google.md)
   ...
   + Gestione delle campagne {#management}
      ...
      + Gestione dei dati all’interno di [!UICONTROL Campaigns] > [!UICONTROL Campaigns] visualizzazioni {#campaigns}
         ...
         + Parole chiave {#keywords}
            ...
            + Impostazioni delle parole chiave per rete di annunci {#keyword-settings-by-network}
               + [[!DNL Baidu] impostazioni delle parole chiave](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-baidu.md)
               + [[!DNL Google Ads] impostazioni delle parole chiave](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-google.md)
               + [[!DNL Microsoft Advertising] impostazioni delle parole chiave](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-microsoft.md)
               + [[!DNL Yahoo! Japan Ads] impostazioni delle parole chiave](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)
               + [[!DNL Yandex] impostazioni delle parole chiave](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yandex.md)
         + Annunci {#ads}
            ...
            + Impostazioni annuncio per rete di annunci {#ad-settings-by-network}
               ...
               + [[!DNL Google Ads] impostazioni annuncio di sola chiamata](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-call.md)
               + [[!DNL Google Ads] impostazioni annunci per ricerca dinamica espansa](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-dsa.md)
               ...
               + [[!DNL Microsoft Advertising] impostazioni annunci per ricerca dinamica espansa](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-dsa.md)
               + [[!DNL Microsoft Advertising] impostazioni degli annunci multimediali](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-multimedia.md)
               + [[!DNL Microsoft Advertising] impostazioni annuncio di prodotto](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-product.md)
               + [[!DNL Microsoft Advertising] impostazioni degli annunci reattivi (pubblico)](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
         ...
         + Destinazioni automatiche {#auto-targets}
            + [Informazioni su [!DNL Google Ads] target di ricerca dinamica](/help/search-social-commerce/campaign-management/campaigns/dynamic-search-target-about.md)
            + [Gestisci [!DNL Google Ads] target di ricerca dinamica](/help/search-social-commerce/campaign-management/campaigns/dynamic-search-target-manage.md)
         + Tipi di pubblico e target di pubblico {#audiences-and-targets}
            + Tipi di pubblico {#audiences}
               ...
               + [Crea [!DNL Google Ads] audience di corrispondenza cliente da [!DNL Adobe] audience](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-adobe-audience.md)
               + [Creare un [!DNL Google Ads] customer match audience da un elenco e-mail di Adobe Campaign](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-campaign-email-list.md)
      ...
      + Gestione di dati in blocco tramite bulksheet {#bulksheets}
         ...
         + Dati richiesti/inclusi nei bulksheet{#bulksheet-data-formats}
            ...
            + [Dati bulksheet per [!DNL Yahoo! Display Network] account](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-display-network.md)
            + [Dati bulksheet per [!DNL Yahoo! Japan] account](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-japan.md)
      ...
      + Implementazione di campagne e annunci con flussi di lavoro univoci{#special-campaign-types}
         + [Implementare [!DNL Google Ads] annunci di ricerca dinamica](/help/search-social-commerce/campaign-management/special-campaign-types/google-dynamic-search-ads.md)
         + [Implementare [!DNL Google Ads] campagne con prestazione massima](/help/search-social-commerce/campaign-management/special-campaign-types/google-performance-max-campaigns.md)
...
+ Approfondimenti e rapporti {#insights-reports}
   + Approfondimenti sulla pubblicità {#insights}
      ...
      + [Visualizza o salva un [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-view-save.md)
      + [Eliminare un [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-delete.md)
   + Rapporti {#reports}
      ...
      + Gestione dei rapporti {#report-management}
         ...
         + Report di precisione modello {#model-accuracy-reports}
            ...
            + Formati dei rapporti sulla precisione del modello {#assist-report-formats}
               + [Il [!UICONTROL Forecast Accuracy Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-report.md)
               + [Il [!UICONTROL Forecast Accuracy (Actuals) Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-actuals-report.md)
      ...
      + Automatizzazione dei rapporti {#report-automation}
         ...
         + Feed del foglio di calcolo {#spreadsheet-feeds}
            ...
            + [Creare un [!DNL Excel] modello per un feed di report per fogli di calcolo](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
      ...
      + [Domande frequenti sui rapporti](/help/search-social-commerce/reports/faqs-report.md)
   + Notifiche {#notifications}
      ...
      + [Abilitare e disabilitare le notifiche push da [!UICONTROL Notification Center]](/help/search-social-commerce/notifications/notifications-push-enable-disable.md)
      + [Installare e disinstallare [!UICONTROL Notification Center] applicazione web](/help/search-social-commerce/notifications/notification-app-install-uninstall.md)
   + Avvisi personalizzati {#alerts}
      ...
      + Modelli di avviso {#alert-templates}
         + [Creare un modello di avviso personalizzato](/help/search-social-commerce/alerts/alert-template-create.md)
...
+ Strumenti {#tools}
   ...
   + Caricamento delle metriche per [!DNL Naver] account di solo tracciamento {#generic-tracking}
...
+ Amministrazione {#admin}
   ...
   + [Sincronizza [!DNL Adobe] audience](/help/search-social-commerce/admin/sync-adobe-audiences.md)
   + Configurazione delle origini dati {#data-sources}
      + [Informazioni sulla sincronizzazione [!DNL Google Analytics] metriche di conversione](/help/search-social-commerce/admin/data-sources/data-source-about.md)
      + [Prerequisiti per la configurazione di un [!DNL Google Analytics] origine dati](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
      + [Configurare un [!DNL Google Analytics] visualizzare come origine dati](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
      + [Modifica un [!DNL Google Analytics] origine dati](/help/search-social-commerce/admin/data-sources/data-source-edit.md)

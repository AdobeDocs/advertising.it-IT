...
Il team dell’account Adobe, il team dell’agenzia o l’inserzionista (a seconda dei termini del service level agreement) devono monitorare le prestazioni di ogni campagna e portfolio (quando applicabile) e modificare i componenti e le impostazioni pertinenti in base alle esigenze per soddisfare gli obiettivi dell’inserzionista.

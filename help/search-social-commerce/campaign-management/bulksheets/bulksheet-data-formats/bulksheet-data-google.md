...
| [!UICONTROL Ad Group Type] | <p>Tipo di gruppo di annunci: <i>[!UICONTROL Discovery]</i> (solo per campagne di individuazione), <i>[!UICONTROL Display]</i> (per campagne di visualizzazione), <i>[!UICONTROL Search Dynamic]</i> (per annunci di ricerca dinamica espansi), <i>[!UICONTROL Search Standard]</i> (per annunci di ricerca), <i>[!UICONTROL Shopping Product]</i> (per annunci di prodotti di acquisto), <i>[!UICONTROL Shopping Showcase]</i> (creazione e modifica non supportate) o <i>[!UICONTROL Unknown]</i>.</p> |
...
Per ulteriori informazioni sulla creazione di annunci per acquisti, consulta &quot;[Implementare [!DNL Google Ads] campagne acquisti](https://experienceleague.adobe.com/docs/advertising/search-social-commerce/campaign-management/management/special-campaign-types/google-shopping-campaigns.html).&quot;

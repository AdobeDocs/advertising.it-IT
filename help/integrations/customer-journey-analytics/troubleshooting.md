...
* La regola viene salvata e inclusa nella [build della libreria](https://experienceleague.adobe.com/en/docs/experience-platform/tags/publish/builds) attiva.
...
* Le condizioni della regola non sono troppo restrittive. Effettua il test [rimuovendo temporaneamente le condizioni](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules) per isolare il problema.
* Ordine delle regole corretto. Se più regole condividono lo stesso evento, controlla l&#39;[ordinamento regole](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules).

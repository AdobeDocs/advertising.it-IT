...
## Passaggio 2: implementare i pixel dell’evento impression e click sulle pagine web {#implement-dsp-pixels}

Gli inserzionisti possono creare e implementare tag evento per i propri marchi. Se necessario, contatta il tuo consulente Adobe Audience Manager o il team del tuo account Adobe per richiedere assistenza.
...
* `[source id]` è l&#39;ID per l&#39;[origine dati](#set-up-data-source) in cui si tiene traccia dell&#39;impression di DSP e si fanno clic sui dati.
...
>[!TIP]
>
>* La best practice prevede l’inclusione degli ID di campagna, posizionamento, creatività (annuncio) e sito, in modo da poter utilizzare gli attributi della campagna per creare le caratteristiche di Audience Manager.
...
1. Identifica l&#39;ID creativo all&#39;interno della campagna DSP, quindi mappalo sulla caratteristica come `d_creative=[Creative ID]`.

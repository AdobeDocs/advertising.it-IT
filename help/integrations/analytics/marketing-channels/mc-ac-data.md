---
title: Utilizzo di  [!DNL Marketing Channels]  con i dati di Adobe Advertising
...
# Utilizzo di [!DNL Analytics Marketing Channels] con i dati di Adobe Advertising

*Inserzionisti con una sola integrazione Adobe Advertising-Adobe Analytics*

Utilizzando i rapporti di Adobe Advertising e [!DNL Analytics Marketing Channels], puoi acquisire preziosi dati di insight sul modo in cui i contenuti multimediali digitali influenzano l&#39;attività del sito.

<!-- from video: By using Marketing Channels with your Adobe Advertising data, you can get a more holistic view of how your advertising efforts are affecting site behavior. In particular, you can see the value of your view-through and click-through data, and how your advertising assists or is assisted by other channels. -->

Nella figura seguente viene illustrato come Adobe Advertising e [!DNL Marketing Channels] tengono traccia delle singole visite che costituiscono il percorso di un visitatore. I rapporti di Adobe Advertising in [!DNL Analytics] sono limitati solo alla pubblicità a pagamento nei canali di visualizzazione, ricerca, social e commercio effettuata attraverso Adobe Advertising, utilizzando l’AMO ID. Tuttavia, [!DNL Marketing Channels] tiene traccia di tutti i canali configurati nelle regole di elaborazione [!DNL Marketing Channels].
...
In [!DNL Analytics], puoi combinare i dati di Adobe Advertising persistenti sulla pubblicità a pagamento e i dati sulle visite complete di [!DNL Marketing Channels] per analizzare meglio le prestazioni multimediali in modo da influenzare meglio il percorso dei clienti.

L’analisi seguente utilizza i dati di Adobe Advertising per mostrare versioni diverse di come una pubblicità display influisce sulla conversione del sito. Tutte e tre le colonne utilizzano le stesse metriche di conversione, ma ogni colonna racconta una storia diversa:

* La colonna 1 esamina i dati AMO ID che rimangono costanti nel percorso del visitatore. La colonna 1 indica che 641 avvii di applicazioni sono stati collegati a un annuncio di Adobe Advertising tramite un evento view-through o click-through. Questa visualizzazione non prende in considerazione nessun&#39;altra attribuzione [!DNL Marketing Channels].

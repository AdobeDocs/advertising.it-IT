...
>[!IMPORTANT]
>
>La best practice prevede l’utilizzo degli stessi intervalli di lookback e dello stesso modello di attribuzione in Adobe Advertising e [!DNL Analytics]. Collabora con il team dell&#39;account di Adobe per identificare le impostazioni correnti e mantenere le configurazioni sincronizzate.
...
Se hai effettuato l’accesso [!DNL Search, Social, & Commerce], è possibile trovare un elenco
...
I report pubblicitari di Adobe catturano solo i media a pagamento trafficati attraverso la pubblicità di Adobe (ricerca a pagamento per [!DNL Advertising Search, Social, & Commerce] annunci e display per annunci pubblicitari DSP), [!DNL Marketing Channels] i rapporti possono tenere traccia di tutti i canali digitali. Questo può causare una discrepanza nel canale per il quale viene attribuita una conversione.
...
Anche se ti dovresti aspettare un tasso di corrispondenza elevato tra l’AMO ID e l’EF ID, non aspettarti una parità del 100% perché AMO ID e EF ID registrano in modo fondamentale dati diversi, e questa differenza può portare a lievi differenze nel totale [!UICONTROL AMO ID Instances] e [!UICONTROL EF ID Instances]. Se il totale [!UICONTROL AMO ID Instances] in [!DNL Analytics] differisci da [!UICONTROL EF ID Instances] tuttavia, in Adobe Advertising di oltre l’1%, contatta il team dell’account Adobe per assistenza.
...
Fortunatamente, anche se problemi come questo sono comuni, di solito non si traducono in un&#39;alta percentuale di discrepanza. Tuttavia, se noti una grande discrepanza tra gli AMO ID in [!DNL Analytics] e gli ID EF in Adobe Advertising, contatta il team dell’account Adobe per assistenza.
...
Adobe Advertising fornisce ad Analytics [le metriche del traffico specifiche per la pubblicità e le relative dimensioni da [!DNL DSP] e [!DNL Search, Social, & Commerce]](advertising-metrics-in-analytics.md). Le metriche fornite da Adobe Advertising sono applicabili solo alle dimensioni pubblicitarie di Adobe specificate e i dati non sono disponibili per altre dimensioni in [!DNL Analytics].
